...
public static class GameEvents
{
    ...
    public static event Action<int, int> GatesProgressChanged;       
    public static event Action<int, int> SwordProgressChanged;         
    public static event Action SwordCollected;
    ...
    public static void RaiseGatesProgress(int current, int total) => GatesProgressChanged?.Invoke(current, total);
    public static void RaiseSwordProgress(int current, int total) => SwordProgressChanged?.Invoke(current, total);
    public static void RaiseSwordCollected() => SwordCollected?.Invoke();
}
